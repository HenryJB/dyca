                ...
                <div class="profile">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <span>
                                <a data-toggle="modal" data-target="#Modal3" style="padding-left:40px;"
                                   class=" blocklink  btn-block font-14" href="#">change photo</a>
                              </span>
                        </div>
                  ...
                  <?= $session->get('student')->date_of_birth ?>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <span class="rounded badge-danger font-14"> <a class="link text-white text-light"
                                                                               href="<?= Yii::$app->request->baseUrl ?>/students/update"><i
                  ...
                  <?= $session->get('student')->twitter_handle ?>
                                    ...
                                    <div class="course-enrolled">
                                        ...
                                        <div class="row">
                                            ...
                                            <img src="<?= Url::to('@web/uploads/courses/' . $course->photo); ?>"
                                                 class="img-fluid">
                                        ...
                                        <div class="col-md-4" style="padding-top:10px;">
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12"><h3 class="title-fut_bold font-14 ">CONTACT
                                                            ADDRESS</h3>
                                    ...
                                    <div class="skills">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4"><a id="skill-link" href="#"><i class="fa fa-plus"></i>
                                                    Add a new skill</a></div>
                                        </div>
                                    ...
                                    <div class="course-enrolled">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="title-bold font-24"><i class="fa fa-book"></i> ENROLLED
                                                    COURSES
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <img src="<?= Url::to('@web/uploads/courses/' . $applied_course->photo); ?>"
                                                                     class="img-fluid img-rounded">
                                                                <h3 class="title-bold font-24 bottom-centered "><?= $applied_course->name ?></h3>
                                                                <div style="margin-top:20px">
                                                                    <a href="<?= Yii::$app->request->baseUrl ?>/payments/tuition-fee?id=<?= $course->id ?>"
                                                                       class="btn btn-danger btn-block rounded">Pay</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4" style="padding-top:36px">
                                                                <div class="row">
                                                                    <div class=" col-md-12"><h3
                                                                                class="title-light font-14">START
                                                                            DATE</h3></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class=" col-md-12"><h3
                                                                                class="title-light font-14">COST</h3>
                                                                    </div>
                                                                    <div class="col-md-12 line-compressed">
                                                                ...
                                                                <div class="row">
                                                                    <div class=" col-md-12"><h3
                                                                                class="title-light font-14">STATUS</h3>
                                                                    </div>
                                    ...
                                    <div class="portfolio">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="title-bold font-24"><i class="fa fa-briefcase"></i>
                                                    PORTFOLIOS
                                                </div>

                                            </div>
                                            <div class="col-md-4"><a id="project-link" data-toggle="modal"
                                                                     data-target="#Modal1" href="#"><i
                                                            class="fa fa-plus"></i> Add a new project</a></div>
                                        </div>
