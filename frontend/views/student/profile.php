            ...
            <div class="col-sm-3 white-padding" style="border-top: 2px solid #A40000">
                <div class="panel widget light-widget panel-bd-top">
                    ...
                    <div class="panel-body">
                        ...
                        <h2 class="font-semibold mgbt-xs-5">
                            <?=$model->first_name . ' '. $model->last_name?>
                        </h2>
                        <h4>
                            <?=$model->state_id.','. $model->country ?>
                        </h4>
                                                ...
                                                <tr class="tr-shadow">
                                                    ...
                                                    <td>
                                                      ...
                                                      'a'=>\lesha724\documentviewer\GoogleDocumentViewer::A_BI
                                                                ...
                                                                <a href="<?=Yii::$app->request->baseUrl?>/projects/view?id=<?= $project->id;?>" class="item" data-toggle="tooltip" data-placement="top"
                                                                ...
                                                                <a href="<?=Yii::$app->request->baseUrl?>/projects/view?id=<?= $project->id;?>" class="item" data-toggle="tooltip" data-placement="top"
                                                                    ...
                                                                    <a href="<?=Yii::$app->request->baseUrl?>/projects/view?id=<?= $project->id;?>" class="item" data-toggle="tooltip" data-placement="top"
                                                                        title="" data-original-title="More">
