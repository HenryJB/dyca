        ...
        <div id="main-wrapper">
                        ...
                        <ul class="navbar-nav float-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="<?=Yii::$app->request->baseUrl?>/site/logout">
                    ...
                    <nav class="sidebar-nav">
                        <ul id="sidebarnav" class="p-t-30">
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=Yii::$app->request->baseUrl?>/students/dashboard" aria-expanded="false">
                                    <i class="mdi mdi-view-dashboard"></i>
                                    <span class="hide-menu">Dashboard</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=Yii::$app->request->baseUrl?>/students/courses-applied"
                                    aria-expanded="false">
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=Yii::$app->request->baseUrl?>/students/projects" aria-expanded="false">
                                    <i class="mdi mdi-chart-bubble"></i>
                                    <span class="hide-menu">Projects</span>
                                </a>
                            </li>
                            <li class="sidebar-item">
                                <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=Yii::$app->request->baseUrl?>/students/grants" aria-expanded="false">
            ...
            <div class="page-wrapper">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?= Html::beginForm(['students/profile-picture'], 'post',['id' => 'profile-picture','enctype' => 'multipart/form-data']) ?>
                                        <div class="card-body">
                ...
                <footer class="footer text-center">
                    <p class="">Copy Right
                        <?=date('Y')?> &copy; By Del-York Creative Academy. All Rights Reserved</p>
                </footer>
                <!-- ============================================================== -->
                <!-- End footer -->
                <!-- ============================================================== -->
